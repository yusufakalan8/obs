...
namespace OTOMASYONV1
{
    public partial class FrmNotListesi : Form
    {
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select Tbl_Dersler.DERSNO, Tbl_Dersler.DERSTURU, Tbl_Dersler.DERSKREDI, Tbl_Dersler.DERSAD, Tbl_Dersler.DERSHOCA, Tbl_Secilen.VIZE, Tbl_Secilen.FINAL, Tbl_Secilen.BUT, Tbl_Secilen.ORTALAMA, Tbl_Secilen.DURUM  from Tbl_Dersler inner join Tbl_Secilen on Tbl_Dersler.DERSNO=Tbl_Secilen.DERSNO where SECEN=@p1", baglanti);
