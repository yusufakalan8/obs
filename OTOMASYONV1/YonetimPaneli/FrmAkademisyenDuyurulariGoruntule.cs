...
{
    public partial class FrmAkademisyenDuyurulariGoruntule : Form
    {
        public FrmAkademisyenDuyurulariGoruntule()
        {
            InitializeComponent();
        }
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select * from Tbl_EgitimciDuyurular", baglanti);
        ...
        private void FrmAkademisyenDuyurulariGoruntule_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void FrmAkademisyenDuyurulariGoruntule_Load(object sender, EventArgs e)
        {
            duyuru();
