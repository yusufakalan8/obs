...
{
    public partial class FrmOgrenciDuyurulariGoruntule : Form
    {
        public FrmOgrenciDuyurulariGoruntule()
        {
            InitializeComponent();
        }
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select * from Tbl_Duyurular", baglanti);
        ...
        private void FrmDuyurulariGoruntule_Load(object sender, EventArgs e)
        {
            duyuru();
        }
        ...
        private void FrmOgrenciDuyurulariGoruntule_Paint(object sender, PaintEventArgs e)
        {
