...
{
    public partial class FrmAkademisyenDuyurular : Form
    {
        public FrmAkademisyenDuyurular()
        {
            InitializeComponent();
        }
        ...
        private void FrmAkademisyenDuyurular_Paint(object sender, PaintEventArgs e)
        {
            ControlPaint.DrawBorder(e.Graphics, this.ClientRectangle, Color.Black, ButtonBorderStyle.Solid);
        }

        private void FrmAkademisyenDuyurular_Load(object sender, EventArgs e)
        {
            duyuru();
        }
    }
